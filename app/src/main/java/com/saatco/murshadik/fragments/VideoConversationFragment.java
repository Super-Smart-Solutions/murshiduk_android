...
import com.saatco.murshadik.adapters.OpponentsFromCallAdapter;
...
public class VideoConversationFragment extends BaseConversationFragment implements Serializable,
    ...
    private ToggleButton cameraToggle, audioSwitchToggleButton;
    ...
    private RelativeLayout fragmentOpponentsLayout;
    ...
    protected void configureToolbar() {
        ...
        toolbar.setBackgroundColor(getResources().getColor(R.color.black_transparent_30, App.getInstance().getTheme()));
        toolbar.setTitleTextColor(getResources().getColor(R.color.black_transparent_30,App.getInstance().getTheme()));
        toolbar.setSubtitleTextColor(getResources().getColor(R.color.black_transparent_30,App.getInstance().getTheme()));
    ...
    protected void initViews(View view) {
        ...
        fragmentOpponentsLayout = view.findViewById(R.id.fragmentOpponents);
        btnCameraSwitch = view.findViewById(R.id.button_camera_switch);
