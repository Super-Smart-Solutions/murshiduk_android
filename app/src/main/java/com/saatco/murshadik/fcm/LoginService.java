...
import com.saatco.murshadik.utils.ChatPingAlarmManager;
...
public class LoginService extends Service {
    ...
    private void loginToChat(QBUser qbUser) {
        chatService.login(qbUser, new QBEntityCallback<QBUser>() {
            ...
            public void onError(QBResponseException e) {
                ...
                if (Objects.requireNonNull(e.getMessage()).contains("You have already logged in chat")){
                    sendResultToActivity(true, null);
                    return;
                }
    ...
    private void initQBRTCClient() {
        ...
        if (chatService != null) {
            if(chatService.getVideoChatWebRTCSignalingManager() != null) {
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        if (!isCallServiceRunning()) {
            Log.v("xWx"," onTaskRemoved logout");
            logout();
        }
    }
