...
import com.saatco.murshadik.constants.StatusType;
...
public class DirManager {
    ...
    private static final String APP_FOLDER_NAME = "AGuide";


    //Main App Folder: /sdcard/FireApp/
    public static String mainAppFolder() {
        File file = new File(App.getInstance().getExternalFilesDir(null) + "/" + APP_FOLDER_NAME + "/");
    ...
    public static File generateFile(int type) {
        ...
        switch (type) {
            ...
            case MessageType.RECEIVED_VOICE_MESSAGE:
                ...
                file = new File(getReceivedFilesFolder() + "/" + generateNewName(type) + EXTENSION_PDF);
                break;
