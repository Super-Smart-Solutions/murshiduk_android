...
public class AppRater {
    ...
    public AppRater(final Context context, final String packageName) {
        ...
        mText_title = context.getString(R.string.rate_dialog_title);
        mText_explanation = context.getString(R.string.rate_dialog_message);
        mText_buttonNow = context.getString(R.string.rate_dialog_ok);
        mText_buttonLater = context.getString(R.string.rate_dialog_cancel);
        mText_buttonNever = context.getString(R.string.rate_dialog_no);
     ...
     * @param dontShow the preference name for the don't-show flag
